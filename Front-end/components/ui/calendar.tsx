    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-accent/50 transition-colors"
        ),
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "bg-accent/20 text-accent-foreground font-bold ring-2 ring-accent/30",
