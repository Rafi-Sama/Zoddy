...
export default function PaymentsPage() {
  return (
    <MainLayout breadcrumbs={[{ label: "Payments" }]}>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600 mb-1.5">
                  85/100
                </div>
                <p className="text-xs text-muted-foreground">
                ...
                <div className="flex items-start space-x-2 p-2 bg-blue-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-blue-600">
                      Revenue is up 12.5%. Consider expanding successful product
                      lines.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-2 p-2 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    <p className="text-xs font-medium text-purple-800">
                      Upcoming: &ldquo;Eid Season&rdquo;
                    </p>
                    <p className="text-[10px] text-purple-600">
                      Prepare for 40% increase in orders. Ensure adequate cash
                      flow.
                    </p>
                  </div>
                </div>
